...
class PostListView(ListView):
    ...
    model = Post
    template_name = 'blog/post_list.html' # Needs creation
...
class PostDetailView(FormMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # No need to fetch translation separately, access fields directly (e.g., post.title)
        # context['post_translation'] = post_translation # Removed
